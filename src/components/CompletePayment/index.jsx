...
const STATUS_CONTENT_MAP = {
    succeeded: {
        ...
        iconColor: "#30B130",
        icon: SuccessIcon,
        buttonText: "Voltar para o início",
        buttonLink: "/",
    },
    processing: {
        text: "Pagmento em processamento.",
        iconColor: "#6D6E78",
        icon: InfoIcon,
        buttonText: "Pedido Sendo processado.",
        buttonLink: "/",
    },
    ...
    return (
        <div className="container">
            <div id="payment-status">
                ...
                <h2 id="status-text" className="status-text">{STATUS_CONTENT_MAP[status].text}</h2>
                ...
                <a id="retry-button" href={STATUS_CONTENT_MAP[status].buttonLink}>{STATUS_CONTENT_MAP[status].buttonText}</a>
            </div>
        </div>
    );
}